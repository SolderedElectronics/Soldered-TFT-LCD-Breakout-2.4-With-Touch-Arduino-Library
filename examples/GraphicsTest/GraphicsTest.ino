 ...
 * @brief       This example will show you how to draw shapes and text on the screen.
 *
 ...
 *              Based on Adafruit's GraphicsTest Example
 ***************************************************/
...
void setup()
{
    ...
    Serial.begin(115200);
    Serial.println("ILI9341 Graphics Test!");
